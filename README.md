...
| US001        | Como ciclista quiero una landing page clara y organizada para entender rápidamente la app       | T003    | Configurar carrusel de imágenes | Desarrollar el componente de carrusel para mostrar imágenes en la landing page. | 5                      |        |        |
| US001        | Como ciclista quiero una landing page clara y organizada para entender rápidamente la app        | T004    | Crear formularios de contacto  | Crear y validar los formularios de contacto en la landing page.    | 3                      |         |       |
